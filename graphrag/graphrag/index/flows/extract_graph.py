...
async def extract_graph(
    ...
    print(f"entities.columns() {entities.columns}")
    print(f"entity_summaries.columns() {entities.columns}")
    print(f"relationships.columns() {relationships.columns}")
    print(f"relationship_summaries.columns() {relationship_summaries.columns}")
